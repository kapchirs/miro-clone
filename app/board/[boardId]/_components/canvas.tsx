...
export const Canvas = ({
    ...
    const updateSelectionNet = useMutation((
        ...
        const ids = findIntersectingLayersWithRectangle(//fix!
            layerIds!,//fix!!
            layers,
            origin,
            current,
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {layerIds && layerIds.map((layerId) => ( //fix
                        <LayerPreview 
                            key={layerId}
                            id={layerId}
                    ...
                    current != null && (
                        <rect 
                            ...
                            width={Math.abs(canvasState.origin.x - canvasState.current.
                            x)}
                            height={Math.abs(canvasState.origin.y - canvasState.current.
                            y)}
                        />
                    )}
                    <CursorsPresence/>
